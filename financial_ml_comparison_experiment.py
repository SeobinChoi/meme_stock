...
class FinancialMLExperiment:
    ...
    def analyze_results(self):
        ...
        summary_table = self.comparison_df.pivot_table(
            index='Model',
            columns='Experiment', 
            values=['Test_IC', 'Test_Hit_Rate', 'Test_RMSE'],
            aggfunc='first'
        ).round(4)
    ...
    def _create_visualizations(self):
        ...
        # Add horizontal line at 0.03 (target)
    ...
    "                f.write(\"-\" * 30 + \"\\n\")\n",
    "                f.write(self.improvements_df.to_string(index=False))\n",
    "                f.write(\"\\n\\n\")\n",
    "                \n",
    "                avg_ic_improvement = self.improvements_df['IC_Improvement'].mean()\n",
    "                avg_hit_improvement = self.improvements_df['Hit_Rate_Improvement'].mean()\n",
    ...
    "            f.write(\"-\" * 30 + \"\\n\")\n",
    "            \n",
    "            if hasattr(self, 'improvements_df') and avg_ic_improvement > 0.01:\n",
    ...
    "            elif hasattr(self, 'improvements_df') and avg_ic_improvement > 0.005:\n",
